...
class Coordinate(models.Model):
    buoy_id = models.ForeignKey(
        Buoy, related_name="coordinate", on_delete=models.CASCADE, db_column="buoy_id")
...
class MeasureTime(models.Model):
    coordinate = models.ForeignKey(
        Coordinate, related_name="measure_time", on_delete=models.CASCADE, db_column="coordinate_id")
...
class Measure(models.Model):
    measure_time = models.ForeignKey(
        MeasureTime, related_name="measure", on_delete=models.CASCADE, db_column="measure_time_id")
